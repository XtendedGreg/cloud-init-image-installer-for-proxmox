...
function usage {
	...
	echo "			'+32G' default if omitted or blank ('')."
	echo ""
	echo "	     Network: Network to attach to VM."
	echo "			'vmbr0' default if omitted or blank ('')."
	echo ""
	echo "	     Storage: Storage name for VM, imported image, and cloudinit YAML file snippet."
	echo "			'local-btrfs' default if omitted or blank ('')."
	echo ""
	echo "	    Username: The username to use for the VM login."
	echo "			OS name will be used by default if omitted or blank ('')."
	echo ""
